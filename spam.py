...
os.system("echo Author: DaengHunter | lolcat -a")
os.system("echo Whatsapp: +6281342077268 | lolcat -a")
os.system("echo Github: https://github.com/daenghunter | lolcat -a")
os.system("echo Instagram: @katagblk | lolcat -a")
os.system("echo x••••••••••••••••••••••••••••••••••••••••••••••••••••••••x | lolcat -a")
